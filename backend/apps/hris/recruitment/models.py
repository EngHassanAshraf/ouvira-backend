...
class PostProbationEvaluation(TimeStampedModel, SoftDeleteModel):
    ...
    application = models.OneToOneField(JobApplication, on_delete=models.CASCADE, related_name="post_probation")
    # Evaluated by Manager after 3 months (placeholder)
    evaluation_date = models.DateField()
    performance_score = models.IntegerField(default=0)
    decision = models.CharField(max_length=50, choices=[("confirmed", "Confirmed"), ("terminated", "Terminated")])
