...
class JobOfferService:
    """
    Service for managing Job Offers and the Final Decision (Hiring).
    """
    ...
    def accept_offer(offer_id, user, employee_data):
        """
        Accepts the offer and performs the 'Final Decision': 
        creating an actual Employee record from the candidate data.
        """
        ...
        # 2. Create Employee in hris_core (The Bridge)
        # Required fields: employee_id, national_id, first_name, last_name, company
        employee = Employee.objects.create(
            company=candidate.company,
            department=application.job_advertisement.hiring_request.department,
        ...
        ActivityLogService.log_activity(
            ...
            new_values={"employee_id": employee.employee_id}
        )
